...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Saving Credentials<br/>Connecting to WiFi network.<br /></div>";
...
const char S_staticip[]           PROGMEM = "Static IP (optional)";
const char S_staticgw[]           PROGMEM = "Static gateway (optional)";
const char S_staticdns[]          PROGMEM = "Static DNS (optional)";
const char S_subnet[]             PROGMEM = "Subnet (optional)";
